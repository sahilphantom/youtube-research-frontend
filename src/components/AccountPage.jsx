...
export default function AccountPage() {
  ...
  <div className="bg-white rounded-lg shadow-md p-6">
    <h2 className="text-xl font-semibold text-gray-900 mb-4">サブスクリプションの詳細</h2>
    ...
    {user?.isSubscribed ? (
      <div className="space-y-4">
        ...
        <div>
          <label className="block text-sm font-medium text-gray-500">更新日</label>
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  <p className="text-sm text-yellow-700">
                    お支払いが滞っています。継続してサービスをご利用いただくには、お支払い方法を更新してください。
                  </p>
                </div>
              </div>
            </div>
      ...
      <div>
        <p className="text-gray-600 mb-4">現在、有効なサブスクリプションはありません。</p>
        <Link
          to="/pricing"
